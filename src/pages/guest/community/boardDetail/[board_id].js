...
const BoardDetails = () => {
    ...
    const handleCommentSubmit = () => {
        ...
        axios.post(`http://localhost:8081/comment/addComment`, {
        ...
        .then(response => {
            ...
            axios.get(`http://localhost:8081/comment/commentFind/${board_id}`)
                .then(response => {
    ...
    const handleCommentDelete = (comment_id) => {
        ...
        axios.delete(`http://localhost:8081/comment/deleteComment/${comment_id}`)
            .then(response => {
    ...
    useEffect(() => {
        if (board_id) { // board_id 값이 존재할 때만 실행
            // 게시물 데이터를 로드합니다
            axios.get(`http://localhost:8081/board/boardlist/${board_id}`)
                .then(response => {
            ...
            // 해당 게시물의 댓글을 로드합니다
            axios.get(`http://localhost:8081/comment/commentFind?board_id=${board_id}`)
                .then(response => {
                    setComments(response.data);
                })
                .catch(error => {
